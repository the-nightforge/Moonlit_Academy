...
import type { GameData, RunAction, RunSetup, RunState } from "../types/index";
 ...
 */
export function replayRun(data: GameData, setup: RunSetup, actions: readonly RunAction[]): ReplayResult {
